...
// node_modules/pst-extractor/dist/OutlookProperties.js
var require_OutlookProperties = __commonJS({
  "node_modules/pst-extractor/dist/OutlookProperties.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OutlookProperties = void 0;
    var OutlookProperties;
    (function(OutlookProperties2) {
      OutlookProperties2[OutlookProperties2["PSETID_Common"] = 1] = "PSETID_Common";
      OutlookProperties2[OutlookProperties2["PSETID_Address"] = 2] = "PSETID_Address";
      OutlookProperties2[OutlookProperties2["PSETID_Appointment"] = 4] = "PSETID_Appointment";
      OutlookProperties2[OutlookProperties2["PSETID_Meeting"] = 5] = "PSETID_Meeting";
      OutlookProperties2[OutlookProperties2["PSETID_Log"] = 6] = "PSETID_Log";
      OutlookProperties2[OutlookProperties2["PR_RTF_COMPRESSED"] = 4105] = "PR_RTF_COMPRESSED";
      OutlookProperties2[OutlookProperties2["PR_NON_RECEIPT_NOTIFICATION_REQUESTED"] = 3078] = "PR_NON_RECEIPT_NOTIFICATION_REQUESTED";
      OutlookProperties2[OutlookProperties2["PR_ORIGINATOR_NON_DELIVERY_REPORT_REQUESTED"] = 3080] = "PR_ORIGINATOR_NON_DELIVERY_REPORT_REQUESTED";
      OutlookProperties2[OutlookProperties2["PR_RECIPIENT_TYPE"] = 3093] = "PR_RECIPIENT_TYPE";
      OutlookProperties2[OutlookProperties2["PR_MESSAGE_CODEPAGE"] = 16381] = "PR_MESSAGE_CODEPAGE";
      OutlookProperties2[OutlookProperties2["PR_INTERNET_CPID"] = 16350] = "PR_INTERNET_CPID";
      OutlookProperties2[OutlookProperties2["PR_RTF_SYNC_BODY_CRC"] = 4102] = "PR_RTF_SYNC_BODY_CRC";
      OutlookProperties2[OutlookProperties2["PR_RTF_SYNC_BODY_COUNT"] = 4103] = "PR_RTF_SYNC_BODY_COUNT";
      OutlookProperties2[OutlookProperties2["PR_RTF_SYNC_BODY_TAG"] = 4104] = "PR_RTF_SYNC_BODY_TAG";
      OutlookProperties2[OutlookProperties2["PR_RTF_SYNC_PREFIX_COUNT"] = 4112] = "PR_RTF_SYNC_PREFIX_COUNT";
      OutlookProperties2[OutlookProperties2["PR_RTF_SYNC_TRAILING_COUNT"] = 4113] = "PR_RTF_SYNC_TRAILING_COUNT";
      OutlookProperties2[OutlookProperties2["PR_BODY"] = 4096] = "PR_BODY";
      OutlookProperties2[OutlookProperties2["PR_BODY_HTML"] = 4115] = "PR_BODY_HTML";
      OutlookProperties2[OutlookProperties2["PR_IMPORTANCE"] = 23] = "PR_IMPORTANCE";
      OutlookProperties2[OutlookProperties2["PR_MESSAGE_CLASS"] = 26] = "PR_MESSAGE_CLASS";
      OutlookProperties2[OutlookProperties2["PR_SUBJECT"] = 55] = "PR_SUBJECT";
      OutlookProperties2[OutlookProperties2["PR_CLIENT_SUBMIT_TIME"] = 57] = "PR_CLIENT_SUBMIT_TIME";
      OutlookProperties2[OutlookProperties2["PR_RECEIVED_BY_NAME"] = 64] = "PR_RECEIVED_BY_NAME";
      OutlookProperties2[OutlookProperties2["PR_SENT_REPRESENTING_NAME"] = 66] = "PR_SENT_REPRESENTING_NAME";
      OutlookProperties2[OutlookProperties2["PR_SENT_REPRESENTING_ADDRTYPE"] = 100] = "PR_SENT_REPRESENTING_ADDRTYPE";
      OutlookProperties2[OutlookProperties2["PR_SENT_REPRESENTING_EMAIL_ADDRESS"] = 101] = "PR_SENT_REPRESENTING_EMAIL_ADDRESS";
      OutlookProperties2[OutlookProperties2["PR_CONVERSATION_TOPIC"] = 112] = "PR_CONVERSATION_TOPIC";
      OutlookProperties2[OutlookProperties2["PR_RECEIVED_BY_ADDRTYPE"] = 117] = "PR_RECEIVED_BY_ADDRTYPE";
      OutlookProperties2[OutlookProperties2["PR_RECEIVED_BY_EMAIL_ADDRESS"] = 118] = "PR_RECEIVED_BY_EMAIL_ADDRESS";
      OutlookProperties2[OutlookProperties2["PR_TRANSPORT_MESSAGE_HEADERS"] = 125] = "PR_TRANSPORT_MESSAGE_HEADERS";
      OutlookProperties2[OutlookProperties2["PR_MESSAGE_FLAGS"] = 3591] = "PR_MESSAGE_FLAGS";
      OutlookProperties2[OutlookProperties2["PR_ORIGINATOR_DELIVERY_REPORT_REQUESTED"] = 35] = "PR_ORIGINATOR_DELIVERY_REPORT_REQUESTED";
      OutlookProperties2[OutlookProperties2["PR_PRIORITY"] = 38] = "PR_PRIORITY";
      OutlookProperties2[OutlookProperties2["PR_READ_RECEIPT_REQUESTED"] = 41] = "PR_READ_RECEIPT_REQUESTED";
      OutlookProperties2[OutlookProperties2["PR_RECIPIENT_REASSIGNMENT_PROHIBITED"] = 43] = "PR_RECIPIENT_REASSIGNMENT_PROHIBITED";
      OutlookProperties2[OutlookProperties2["PR_SENSITIVITY"] = 54] = "PR_SENSITIVITY";
      OutlookProperties2[OutlookProperties2["PR_ORIGINAL_SENSITIVITY"] = 46] = "PR_ORIGINAL_SENSITIVITY";
      OutlookProperties2[OutlookProperties2["PR_SENT_REPRESENTING_SEARCH_KEY"] = 59] = "PR_SENT_REPRESENTING_SEARCH_KEY";
      OutlookProperties2[OutlookProperties2["PR_RCVD_REPRESENTING_NAME"] = 68] = "PR_RCVD_REPRESENTING_NAME";
      OutlookProperties2[OutlookProperties2["PR_ORIGINAL_SUBJECT"] = 73] = "PR_ORIGINAL_SUBJECT";
      OutlookProperties2[OutlookProperties2["PR_REPLY_RECIPIENT_NAMES"] = 80] = "PR_REPLY_RECIPIENT_NAMES";
      OutlookProperties2[OutlookProperties2["PR_MESSAGE_TO_ME"] = 87] = "PR_MESSAGE_TO_ME";
      OutlookProperties2[OutlookProperties2["PR_MESSAGE_CC_ME"] = 88] = "PR_MESSAGE_CC_ME";
      OutlookProperties2[OutlookProperties2["PR_MESSAGE_RECIP_ME"] = 89] = "PR_MESSAGE_RECIP_ME";
      OutlookProperties2[OutlookProperties2["PR_RESPONSE_REQUESTED"] = 99] = "PR_RESPONSE_REQUESTED";
      OutlookProperties2[OutlookProperties2["PR_ORIGINAL_DISPLAY_BCC"] = 114] = "PR_ORIGINAL_DISPLAY_BCC";
      OutlookProperties2[OutlookProperties2["PR_ORIGINAL_DISPLAY_CC"] = 115] = "PR_ORIGINAL_DISPLAY_CC";
      OutlookProperties2[OutlookProperties2["PR_ORIGINAL_DISPLAY_TO"] = 116] = "PR_ORIGINAL_DISPLAY_TO";
      OutlookProperties2[OutlookProperties2["PR_RCVD_REPRESENTING_ADDRTYPE"] = 119] = "PR_RCVD_REPRESENTING_ADDRTYPE";
      OutlookProperties2[OutlookProperties2["PR_RCVD_REPRESENTING_EMAIL_ADDRESS"] = 120] = "PR_RCVD_REPRESENTING_EMAIL_ADDRESS";
      OutlookProperties2[OutlookProperties2["PR_REPLY_REQUESTED"] = 3095] = "PR_REPLY_REQUESTED";
      OutlookProperties2[OutlookProperties2["PR_SENDER_ENTRYID"] = 3097] = "PR_SENDER_ENTRYID";
      OutlookProperties2[OutlookProperties2["PR_SENDER_NAME"] = 3098] = "PR_SENDER_NAME";
      OutlookProperties2[OutlookProperties2["PR_SENDER_ADDRTYPE"] = 3102] = "PR_SENDER_ADDRTYPE";
      OutlookProperties2[OutlookProperties2["PR_SENDER_EMAIL_ADDRESS"] = 3103] = "PR_SENDER_EMAIL_ADDRESS";
      OutlookProperties2[OutlookProperties2["PR_MESSAGE_SIZE"] = 3592] = "PR_MESSAGE_SIZE";
      OutlookProperties2[OutlookProperties2["PR_INTERNET_ARTICLE_NUMBER"] = 3619] = "PR_INTERNET_ARTICLE_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_PRIMARY_SEND_ACCOUNT"] = 3624] = "PR_PRIMARY_SEND_ACCOUNT";
      OutlookProperties2[OutlookProperties2["PR_NEXT_SEND_ACCT"] = 3625] = "PR_NEXT_SEND_ACCT";
      OutlookProperties2[OutlookProperties2["PR_OBJECT_TYPE"] = 4094] = "PR_OBJECT_TYPE";
      OutlookProperties2[OutlookProperties2["PR_DELETE_AFTER_SUBMIT"] = 3585] = "PR_DELETE_AFTER_SUBMIT";
      OutlookProperties2[OutlookProperties2["PR_RESPONSIBILITY"] = 3599] = "PR_RESPONSIBILITY";
      OutlookProperties2[OutlookProperties2["PR_RTF_IN_SYNC"] = 3615] = "PR_RTF_IN_SYNC";
      OutlookProperties2[OutlookProperties2["PR_DISPLAY_BCC"] = 3586] = "PR_DISPLAY_BCC";
      OutlookProperties2[OutlookProperties2["PR_DISPLAY_CC"] = 3587] = "PR_DISPLAY_CC";
      OutlookProperties2[OutlookProperties2["PR_DISPLAY_TO"] = 3588] = "PR_DISPLAY_TO";
      OutlookProperties2[OutlookProperties2["PR_MESSAGE_DELIVERY_TIME"] = 3590] = "PR_MESSAGE_DELIVERY_TIME";
      OutlookProperties2[OutlookProperties2["PR_INTERNET_MESSAGE_ID"] = 4149] = "PR_INTERNET_MESSAGE_ID";
      OutlookProperties2[OutlookProperties2["PR_IN_REPLY_TO_ID"] = 4162] = "PR_IN_REPLY_TO_ID";
      OutlookProperties2[OutlookProperties2["PR_INTERNET_RETURN_PATH"] = 4166] = "PR_INTERNET_RETURN_PATH";
      OutlookProperties2[OutlookProperties2["PR_ICON_INDEX"] = 4224] = "PR_ICON_INDEX";
      OutlookProperties2[OutlookProperties2["PR_LAST_VERB_EXECUTED"] = 4225] = "PR_LAST_VERB_EXECUTED";
      OutlookProperties2[OutlookProperties2["PR_LAST_VERB_EXECUTION_TIME"] = 4226] = "PR_LAST_VERB_EXECUTION_TIME";
      OutlookProperties2[OutlookProperties2["PR_URL_COMP_NAME"] = 4339] = "PR_URL_COMP_NAME";
      OutlookProperties2[OutlookProperties2["PR_ATTR_HIDDEN"] = 4340] = "PR_ATTR_HIDDEN";
      OutlookProperties2[OutlookProperties2["PR_EMAIL_ADDRESS"] = 12291] = "PR_EMAIL_ADDRESS";
      OutlookProperties2[OutlookProperties2["PR_ADDRTYPE"] = 12290] = "PR_ADDRTYPE";
      OutlookProperties2[OutlookProperties2["PR_COMMENT"] = 12292] = "PR_COMMENT";
      OutlookProperties2[OutlookProperties2["PR_CREATION_TIME"] = 12295] = "PR_CREATION_TIME";
      OutlookProperties2[OutlookProperties2["PR_LAST_MODIFICATION_TIME"] = 12296] = "PR_LAST_MODIFICATION_TIME";
      OutlookProperties2[OutlookProperties2["PR_ATTACH_DATA_BIN"] = 14081] = "PR_ATTACH_DATA_BIN";
      OutlookProperties2[OutlookProperties2["PR_ATTACH_SIZE"] = 3616] = "PR_ATTACH_SIZE";
      OutlookProperties2[OutlookProperties2["PR_ATTACH_FILENAME"] = 14084] = "PR_ATTACH_FILENAME";
      OutlookProperties2[OutlookProperties2["PR_ATTACH_NUM"] = 3617] = "PR_ATTACH_NUM";
      OutlookProperties2[OutlookProperties2["PR_ATTACH_METHOD"] = 14085] = "PR_ATTACH_METHOD";
      OutlookProperties2[OutlookProperties2["PR_ATTACH_LONG_FILENAME"] = 14087] = "PR_ATTACH_LONG_FILENAME";
      OutlookProperties2[OutlookProperties2["PR_ATTACH_PATHNAME"] = 14088] = "PR_ATTACH_PATHNAME";
      OutlookProperties2[OutlookProperties2["PR_RENDERING_POSITION"] = 14091] = "PR_RENDERING_POSITION";
      OutlookProperties2[OutlookProperties2["PR_ATTACH_LONG_PATHNAME"] = 14093] = "PR_ATTACH_LONG_PATHNAME";
      OutlookProperties2[OutlookProperties2["PR_ATTACH_MIME_TAG"] = 14094] = "PR_ATTACH_MIME_TAG";
      OutlookProperties2[OutlookProperties2["PR_ATTACH_MIME_SEQUENCE"] = 14096] = "PR_ATTACH_MIME_SEQUENCE";
      OutlookProperties2[OutlookProperties2["PR_ATTACH_CONTENT_ID"] = 14098] = "PR_ATTACH_CONTENT_ID";
      OutlookProperties2[OutlookProperties2["PR_ATTACH_FLAGS"] = 14100] = "PR_ATTACH_FLAGS";
      OutlookProperties2[OutlookProperties2["PR_ACCOUNT"] = 14848] = "PR_ACCOUNT";
      OutlookProperties2[OutlookProperties2["PR_CALLBACK_TELEPHONE_NUMBER"] = 14850] = "PR_CALLBACK_TELEPHONE_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_GENERATION"] = 14853] = "PR_GENERATION";
      OutlookProperties2[OutlookProperties2["PR_GIVEN_NAME"] = 14854] = "PR_GIVEN_NAME";
      OutlookProperties2[OutlookProperties2["PR_GOVERNMENT_ID_NUMBER"] = 14855] = "PR_GOVERNMENT_ID_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_BUSINESS_TELEPHONE_NUMBER"] = 14856] = "PR_BUSINESS_TELEPHONE_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_HOME_TELEPHONE_NUMBER"] = 14857] = "PR_HOME_TELEPHONE_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_INITIALS"] = 14858] = "PR_INITIALS";
      OutlookProperties2[OutlookProperties2["PR_KEYWORD"] = 14859] = "PR_KEYWORD";
      OutlookProperties2[OutlookProperties2["PR_LANGUAGE"] = 14860] = "PR_LANGUAGE";
      OutlookProperties2[OutlookProperties2["PR_LOCATION"] = 14861] = "PR_LOCATION";
      OutlookProperties2[OutlookProperties2["PR_MHS_COMMON_NAME"] = 14863] = "PR_MHS_COMMON_NAME";
      OutlookProperties2[OutlookProperties2["PR_ORGANIZATIONAL_ID_NUMBER"] = 14864] = "PR_ORGANIZATIONAL_ID_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_SURNAME"] = 14865] = "PR_SURNAME";
      OutlookProperties2[OutlookProperties2["PR_ORIGINAL_DISPLAY_NAME"] = 14867] = "PR_ORIGINAL_DISPLAY_NAME";
      OutlookProperties2[OutlookProperties2["PR_POSTAL_ADDRESS"] = 14869] = "PR_POSTAL_ADDRESS";
      OutlookProperties2[OutlookProperties2["PT_UNICODE"] = 14870] = "PT_UNICODE";
      OutlookProperties2[OutlookProperties2["PR_TITLE"] = 14871] = "PR_TITLE";
      OutlookProperties2[OutlookProperties2["PR_DEPARTMENT_NAME"] = 14872] = "PR_DEPARTMENT_NAME";
      OutlookProperties2[OutlookProperties2["PR_OFFICE_LOCATION"] = 14873] = "PR_OFFICE_LOCATION";
      OutlookProperties2[OutlookProperties2["PR_PRIMARY_TELEPHONE_NUMBER"] = 14874] = "PR_PRIMARY_TELEPHONE_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_BUSINESS2_TELEPHONE_NUMBER"] = 14875] = "PR_BUSINESS2_TELEPHONE_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_MOBILE_TELEPHONE_NUMBER"] = 14876] = "PR_MOBILE_TELEPHONE_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_RADIO_TELEPHONE_NUMBER"] = 14877] = "PR_RADIO_TELEPHONE_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_CAR_TELEPHONE_NUMBER"] = 14878] = "PR_CAR_TELEPHONE_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_OTHER_TELEPHONE_NUMBER"] = 14879] = "PR_OTHER_TELEPHONE_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_TRANSMITABLE_DISPLAY_NAME"] = 14880] = "PR_TRANSMITABLE_DISPLAY_NAME";
      OutlookProperties2[OutlookProperties2["PR_PAGER_TELEPHONE_NUMBER"] = 14881] = "PR_PAGER_TELEPHONE_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_PRIMARY_FAX_NUMBER"] = 14883] = "PR_PRIMARY_FAX_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_BUSINESS_FAX_NUMBER"] = 14884] = "PR_BUSINESS_FAX_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_HOME_FAX_NUMBER"] = 14885] = "PR_HOME_FAX_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_COUNTRY"] = 14886] = "PR_COUNTRY";
      OutlookProperties2[OutlookProperties2["PR_LOCALITY"] = 14887] = "PR_LOCALITY";
      OutlookProperties2[OutlookProperties2["PR_STATE_OR_PROVINCE"] = 14888] = "PR_STATE_OR_PROVINCE";
      OutlookProperties2[OutlookProperties2["PR_STREET_ADDRESS"] = 14889] = "PR_STREET_ADDRESS";
      OutlookProperties2[OutlookProperties2["PR_POSTAL_CODE"] = 14890] = "PR_POSTAL_CODE";
      OutlookProperties2[OutlookProperties2["PR_POST_OFFICE_BOX"] = 14891] = "PR_POST_OFFICE_BOX";
      OutlookProperties2[OutlookProperties2["PR_TELEX_NUMBER"] = 14892] = "PR_TELEX_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_ISDN_NUMBER"] = 14893] = "PR_ISDN_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_ASSISTANT_TELEPHONE_NUMBER"] = 14894] = "PR_ASSISTANT_TELEPHONE_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_HOME2_TELEPHONE_NUMBER"] = 14895] = "PR_HOME2_TELEPHONE_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_ASSISTANT"] = 14896] = "PR_ASSISTANT";
      OutlookProperties2[OutlookProperties2["PR_HOBBIES"] = 14915] = "PR_HOBBIES";
      OutlookProperties2[OutlookProperties2["PR_MIDDLE_NAME"] = 14916] = "PR_MIDDLE_NAME";
      OutlookProperties2[OutlookProperties2["PR_DISPLAY_NAME_PREFIX"] = 14917] = "PR_DISPLAY_NAME_PREFIX";
      OutlookProperties2[OutlookProperties2["PR_PROFESSION"] = 14918] = "PR_PROFESSION";
      OutlookProperties2[OutlookProperties2["PR_REFERRED_BY_NAME"] = 14919] = "PR_REFERRED_BY_NAME";
      OutlookProperties2[OutlookProperties2["PR_SPOUSE_NAME"] = 14920] = "PR_SPOUSE_NAME";
      OutlookProperties2[OutlookProperties2["PR_COMPUTER_NETWORK_NAME"] = 14921] = "PR_COMPUTER_NETWORK_NAME";
      OutlookProperties2[OutlookProperties2["PR_CUSTOMER_ID"] = 14922] = "PR_CUSTOMER_ID";
      OutlookProperties2[OutlookProperties2["PR_TTYTDD_PHONE_NUMBER"] = 14923] = "PR_TTYTDD_PHONE_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_FTP_SITE"] = 14924] = "PR_FTP_SITE";
      OutlookProperties2[OutlookProperties2["PR_MANAGER_NAME"] = 14926] = "PR_MANAGER_NAME";
      OutlookProperties2[OutlookProperties2["PR_NICKNAME"] = 14927] = "PR_NICKNAME";
      OutlookProperties2[OutlookProperties2["PR_PERSONAL_HOME_PAGE"] = 14928] = "PR_PERSONAL_HOME_PAGE";
      OutlookProperties2[OutlookProperties2["PR_BUSINESS_HOME_PAGE"] = 14929] = "PR_BUSINESS_HOME_PAGE";
      OutlookProperties2[OutlookProperties2["PR_COMPANY_MAIN_PHONE_NUMBER"] = 14935] = "PR_COMPANY_MAIN_PHONE_NUMBER";
      OutlookProperties2[OutlookProperties2["PR_CHILDRENS_NAMES"] = 14936] = "PR_CHILDRENS_NAMES";
      OutlookProperties2[OutlookProperties2["PR_HOME_ADDRESS_CITY"] = 14937] = "PR_HOME_ADDRESS_CITY";
      OutlookProperties2[OutlookProperties2["PR_HOME_ADDRESS_COUNTRY"] = 14938] = "PR_HOME_ADDRESS_COUNTRY";
      OutlookProperties2[OutlookProperties2["PR_HOME_ADDRESS_POSTAL_CODE"] = 14939] = "PR_HOME_ADDRESS_POSTAL_CODE";
      OutlookProperties2[OutlookProperties2["PR_HOME_ADDRESS_STATE_OR_PROVINCE"] = 14940] = "PR_HOME_ADDRESS_STATE_OR_PROVINCE";
      OutlookProperties2[OutlookProperties2["PR_HOME_ADDRESS_STREET"] = 14941] = "PR_HOME_ADDRESS_STREET";
      OutlookProperties2[OutlookProperties2["PR_HOME_ADDRESS_POST_OFFICE_BOX"] = 14942] = "PR_HOME_ADDRESS_POST_OFFICE_BOX";
      OutlookProperties2[OutlookProperties2["PR_OTHER_ADDRESS_CITY"] = 14943] = "PR_OTHER_ADDRESS_CITY";
      OutlookProperties2[OutlookProperties2["PR_OTHER_ADDRESS_COUNTRY"] = 14944] = "PR_OTHER_ADDRESS_COUNTRY";
      OutlookProperties2[OutlookProperties2["PR_OTHER_ADDRESS_POSTAL_CODE"] = 14945] = "PR_OTHER_ADDRESS_POSTAL_CODE";
      OutlookProperties2[OutlookProperties2["PR_OTHER_ADDRESS_STATE_OR_PROVINCE"] = 14946] = "PR_OTHER_ADDRESS_STATE_OR_PROVINCE";
      OutlookProperties2[OutlookProperties2["PR_OTHER_ADDRESS_STREET"] = 14947] = "PR_OTHER_ADDRESS_STREET";
      OutlookProperties2[OutlookProperties2["PR_OTHER_ADDRESS_POST_OFFICE_BOX"] = 14948] = "PR_OTHER_ADDRESS_POST_OFFICE_BOX";
      OutlookProperties2[OutlookProperties2["PR_FOLDER_TYPE"] = 13825] = "PR_FOLDER_TYPE";
      OutlookProperties2[OutlookProperties2["PR_CONTENT_COUNT"] = 13826] = "PR_CONTENT_COUNT";
      OutlookProperties2[OutlookProperties2["PR_CONTENT_UNREAD"] = 13827] = "PR_CONTENT_UNREAD";
      OutlookProperties2[OutlookProperties2["PR_SUBFOLDERS"] = 13834] = "PR_SUBFOLDERS";
      OutlookProperties2[OutlookProperties2["PR_CONTAINER_CLASS"] = 13843] = "PR_CONTAINER_CLASS";
      OutlookProperties2[OutlookProperties2["PR_CONTAINER_FLAGS"] = 13824] = "PR_CONTAINER_FLAGS";
      OutlookProperties2[OutlookProperties2["PR_DISPLAY_NAME"] = 12289] = "PR_DISPLAY_NAME";
      OutlookProperties2[OutlookProperties2["PR_RECIPIENT_FLAGS"] = 24573] = "PR_RECIPIENT_FLAGS";
      OutlookProperties2[OutlookProperties2["PR_SMTP_ADDRESS"] = 14846] = "PR_SMTP_ADDRESS";
      OutlookProperties2[OutlookProperties2["PidTagRecipientOrder"] = 24543] = "PidTagRecipientOrder";
      OutlookProperties2[OutlookProperties2["PidTagConversationId"] = 12307] = "PidTagConversationId";
      OutlookProperties2[OutlookProperties2["PidTagConversationIndexTracking"] = 12310] = "PidTagConversationIndexTracking";
      OutlookProperties2[OutlookProperties2["PidLidLogType"] = 34560] = "PidLidLogType";
      OutlookProperties2[OutlookProperties2["PidLidTaskStartDate"] = 33028] = "PidLidTaskStartDate";
      OutlookProperties2[OutlookProperties2["PidLidTaskDueDate"] = 33029] = "PidLidTaskDueDate";
      OutlookProperties2[OutlookProperties2["PidLidReminderSet"] = 34051] = "PidLidReminderSet";
      OutlookProperties2[OutlookProperties2["PidLidReminderDelta"] = 34049] = "PidLidReminderDelta";
      OutlookProperties2[OutlookProperties2["PidLidLogStart"] = 34566] = "PidLidLogStart";
      OutlookProperties2[OutlookProperties2["PidLidLogDuration"] = 34567] = "PidLidLogDuration";
      OutlookProperties2[OutlookProperties2["PidLidLogEnd"] = 34568] = "PidLidLogEnd";
      OutlookProperties2[OutlookProperties2["PidLidLogFlags"] = 34572] = "PidLidLogFlags";
      OutlookProperties2[OutlookProperties2["PidLidLogDocumentPrinted"] = 34574] = "PidLidLogDocumentPrinted";
      OutlookProperties2[OutlookProperties2["PidLidLogDocumentSaved"] = 34575] = "PidLidLogDocumentSaved";
      OutlookProperties2[OutlookProperties2["PidLidLogDocumentRouted"] = 34576] = "PidLidLogDocumentRouted";
      OutlookProperties2[OutlookProperties2["PidLidLogDocumentPosted"] = 34577] = "PidLidLogDocumentPosted";
      OutlookProperties2[OutlookProperties2["PidLidLogTypeDesc"] = 34578] = "PidLidLogTypeDesc";
      OutlookProperties2[OutlookProperties2["PidLidSendMeetingAsIcal"] = 33280] = "PidLidSendMeetingAsIcal";
      OutlookProperties2[OutlookProperties2["PidLidBusyStatus"] = 33285] = "PidLidBusyStatus";
      OutlookProperties2[OutlookProperties2["PidLidLocation"] = 33288] = "PidLidLocation";
      OutlookProperties2[OutlookProperties2["PidLidAppointmentStartWhole"] = 33293] = "PidLidAppointmentStartWhole";
      OutlookProperties2[OutlookProperties2["PidLidAppointmentEndWhole"] = 33294] = "PidLidAppointmentEndWhole";
      OutlookProperties2[OutlookProperties2["PidLidAppointmentDuration"] = 33299] = "PidLidAppointmentDuration";
      OutlookProperties2[OutlookProperties2["PidLidAppointmentColor"] = 33300] = "PidLidAppointmentColor";
      OutlookProperties2[OutlookProperties2["PidLidAppointmentSubType"] = 33301] = "PidLidAppointmentSubType";
      OutlookProperties2[OutlookProperties2["PidLidAppointmentStateFlags"] = 33303] = "PidLidAppointmentStateFlags";
      OutlookProperties2[OutlookProperties2["PidLidResponseStatus"] = 33304] = "PidLidResponseStatus";
      OutlookProperties2[OutlookProperties2["PidLidRecurring"] = 33315] = "PidLidRecurring";
      OutlookProperties2[OutlookProperties2["PidLidExceptionReplaceTime"] = 33320] = "PidLidExceptionReplaceTime";
      OutlookProperties2[OutlookProperties2["PidLidRecurrenceType"] = 33329] = "PidLidRecurrenceType";
      OutlookProperties2[OutlookProperties2["PidLidRecurrencePattern"] = 33330] = "PidLidRecurrencePattern";
      OutlookProperties2[OutlookProperties2["PidLidAppointmentRecur"] = 33302] = "PidLidAppointmentRecur";
      OutlookProperties2[OutlookProperties2["PidLidTimeZoneStruct"] = 33331] = "PidLidTimeZoneStruct";
      OutlookProperties2[OutlookProperties2["PidLidAllAttendeesString"] = 33336] = "PidLidAllAttendeesString";
      OutlookProperties2[OutlookProperties2["PidLidToAttendeesString"] = 33339] = "PidLidToAttendeesString";
      OutlookProperties2[OutlookProperties2["PidLidCcAttendeesString"] = 33340] = "PidLidCcAttendeesString";
      OutlookProperties2[OutlookProperties2["PidLidAppointmentSequence"] = 33281] = "PidLidAppointmentSequence";
      OutlookProperties2[OutlookProperties2["PidLidConferencingCheck"] = 33344] = "PidLidConferencingCheck";
      OutlookProperties2[OutlookProperties2["PidLidConferencingType"] = 33345] = "PidLidConferencingType";
      OutlookProperties2[OutlookProperties2["PidLidDirectory"] = 33346] = "PidLidDirectory";
      OutlookProperties2[OutlookProperties2["PidLidOrganizerAlias"] = 33347] = "PidLidOrganizerAlias";
      OutlookProperties2[OutlookProperties2["PidLidNetShowUrl"] = 33352] = "PidLidNetShowUrl";
      OutlookProperties2[OutlookProperties2["PidLidCollaborateDoc"] = 33351] = "PidLidCollaborateDoc";
      OutlookProperties2[OutlookProperties2["PidLidAttendeeCriticalChange"] = 1] = "PidLidAttendeeCriticalChange";
      OutlookProperties2[OutlookProperties2["PidLidAppointmentCounterProposal"] = 33367] = "PidLidAppointmentCounterProposal";
      OutlookProperties2[OutlookProperties2["PidLidIsSilent"] = 4] = "PidLidIsSilent";
      OutlookProperties2[OutlookProperties2["PidLidRequiredAttendees"] = 6] = "PidLidRequiredAttendees";
      OutlookProperties2[OutlookProperties2["PidTagMessageLocaleId"] = 16369] = "PidTagMessageLocaleId";
      OutlookProperties2[OutlookProperties2["PidLidFileUnder"] = 32773] = "PidLidFileUnder";
      OutlookProperties2[OutlookProperties2["PidLidHomeAddress"] = 32794] = "PidLidHomeAddress";
      OutlookProperties2[OutlookProperties2["PidLidWorkAddress"] = 32795] = "PidLidWorkAddress";
      OutlookProperties2[OutlookProperties2["PidLidOtherAddress"] = 32796] = "PidLidOtherAddress";
      OutlookProperties2[OutlookProperties2["PidLidPostalAddressId"] = 32802] = "PidLidPostalAddressId";
      OutlookProperties2[OutlookProperties2["PidLidHtml"] = 32811] = "PidLidHtml";
      OutlookProperties2[OutlookProperties2["PidLidWorkAddressStreet"] = 32837] = "PidLidWorkAddressStreet";
      OutlookProperties2[OutlookProperties2["PidLidWorkAddressCity"] = 32838] = "PidLidWorkAddressCity";
      OutlookProperties2[OutlookProperties2["PidLidWorkAddressState"] = 32839] = "PidLidWorkAddressState";
      OutlookProperties2[OutlookProperties2["PidLidWorkAddressPostalCode"] = 32840] = "PidLidWorkAddressPostalCode";
      OutlookProperties2[OutlookProperties2["PidLidWorkAddressCountry"] = 32841] = "PidLidWorkAddressCountry";
      OutlookProperties2[OutlookProperties2["PidLidWorkAddressPostOfficeBox"] = 32842] = "PidLidWorkAddressPostOfficeBox";
      OutlookProperties2[OutlookProperties2["PidLidInstantMessagingAddress"] = 32866] = "PidLidInstantMessagingAddress";
      OutlookProperties2[OutlookProperties2["PidLidEmail1DisplayName"] = 32896] = "PidLidEmail1DisplayName";
      OutlookProperties2[OutlookProperties2["PidLidEmail1AddressType"] = 32898] = "PidLidEmail1AddressType";
      OutlookProperties2[OutlookProperties2["PidLidEmail1EmailAddress"] = 32899] = "PidLidEmail1EmailAddress";
      OutlookProperties2[OutlookProperties2["PidLidEmail1OriginalDisplayName"] = 32900] = "PidLidEmail1OriginalDisplayName";
      OutlookProperties2[OutlookProperties2["PidLidEmail2DisplayName"] = 32912] = "PidLidEmail2DisplayName";
      OutlookProperties2[OutlookProperties2["PidLidEmail2AddressType"] = 32914] = "PidLidEmail2AddressType";
      OutlookProperties2[OutlookProperties2["PidLidEmail2EmailAddress"] = 32915] = "PidLidEmail2EmailAddress";
      OutlookProperties2[OutlookProperties2["PidLidEmail2OriginalDisplayName"] = 32916] = "PidLidEmail2OriginalDisplayName";
      OutlookProperties2[OutlookProperties2["PidLidEmail3DisplayName"] = 32928] = "PidLidEmail3DisplayName";
      OutlookProperties2[OutlookProperties2["PidLidEmail3AddressType"] = 32930] = "PidLidEmail3AddressType";
      OutlookProperties2[OutlookProperties2["PidLidEmail3EmailAddress"] = 32931] = "PidLidEmail3EmailAddress";
      OutlookProperties2[OutlookProperties2["PidLidEmail3OriginalDisplayName"] = 32932] = "PidLidEmail3OriginalDisplayName";
      OutlookProperties2[OutlookProperties2["PidLidFax1AddressType"] = 32946] = "PidLidFax1AddressType";
      OutlookProperties2[OutlookProperties2["PidLidFax1EmailAddress"] = 32947] = "PidLidFax1EmailAddress";
      OutlookProperties2[OutlookProperties2["PidLidFax1OriginalDisplayName"] = 32948] = "PidLidFax1OriginalDisplayName";
      OutlookProperties2[OutlookProperties2["PidLidFax2AddressType"] = 32962] = "PidLidFax2AddressType";
      OutlookProperties2[OutlookProperties2["PidLidFax2EmailAddress"] = 32963] = "PidLidFax2EmailAddress";
      OutlookProperties2[OutlookProperties2["PidLidFax2OriginalDisplayName"] = 32964] = "PidLidFax2OriginalDisplayName";
      OutlookProperties2[OutlookProperties2["PidLidFax3AddressType"] = 32978] = "PidLidFax3AddressType";
      OutlookProperties2[OutlookProperties2["PidLidFax3EmailAddress"] = 32979] = "PidLidFax3EmailAddress";
      OutlookProperties2[OutlookProperties2["PidLidFax3OriginalDisplayName"] = 32980] = "PidLidFax3OriginalDisplayName";
      OutlookProperties2[OutlookProperties2["PidLidFreeBusyLocation"] = 32984] = "PidLidFreeBusyLocation";
      OutlookProperties2[OutlookProperties2["PidTagBirthday"] = 14914] = "PidTagBirthday";
      OutlookProperties2[OutlookProperties2["PidTagWeddingAnniversary"] = 14913] = "PidTagWeddingAnniversary";
      OutlookProperties2[OutlookProperties2["PidLidPercentComplete"] = 33026] = "PidLidPercentComplete";
      OutlookProperties2[OutlookProperties2["PidLidTaskStatus"] = 33025] = "PidLidTaskStatus";
      OutlookProperties2[OutlookProperties2["PidLidTaskDeadOccurrence"] = 33033] = "PidLidTaskDeadOccurrence";
      OutlookProperties2[OutlookProperties2["PidLidTaskDateCompleted"] = 33039] = "PidLidTaskDateCompleted";
      OutlookProperties2[OutlookProperties2["PidLidTaskActualEffort"] = 33040] = "PidLidTaskActualEffort";
      OutlookProperties2[OutlookProperties2["PidLidTaskEstimatedEffort"] = 33041] = "PidLidTaskEstimatedEffort";
      OutlookProperties2[OutlookProperties2["PidLidTaskVersion"] = 33042] = "PidLidTaskVersion";
      OutlookProperties2[OutlookProperties2["PidLidTaskRecurrence"] = 33046] = "PidLidTaskRecurrence";
      OutlookProperties2[OutlookProperties2["PidLidTaskComplete"] = 33052] = "PidLidTaskComplete";
      OutlookProperties2[OutlookProperties2["PidLidTaskOwner"] = 33055] = "PidLidTaskOwner";
      OutlookProperties2[OutlookProperties2["PidLidTaskAssigner"] = 33057] = "PidLidTaskAssigner";
      OutlookProperties2[OutlookProperties2["PidLidTaskLastUser"] = 33058] = "PidLidTaskLastUser";
      OutlookProperties2[OutlookProperties2["PidLidTaskOrdinal"] = 33059] = "PidLidTaskOrdinal";
      OutlookProperties2[OutlookProperties2["PidLidTaskFRecurring"] = 33062] = "PidLidTaskFRecurring";
      OutlookProperties2[OutlookProperties2["PidLidTaskOwnership"] = 33065] = "PidLidTaskOwnership";
      OutlookProperties2[OutlookProperties2["PidLidTaskAcceptanceState"] = 33066] = "PidLidTaskAcceptanceState";
    })(OutlookProperties || (exports.OutlookProperties = OutlookProperties = {}));
  }
});

// node_modules/pst-extractor/dist/PSTDescriptorItem.class.js
var require_PSTDescriptorItem_class = __commonJS({
  "node_modules/pst-extractor/dist/PSTDescriptorItem.class.js"(exports) {
    "use strict";
    ...
    var PSTUtil_class_1 = require_PSTUtil_class();
    var PSTFile_class_1 = require_PSTFile_class();
    var PSTDescriptorItem = class {
      ...
      constructor(data, offset, pstFile, entryType) {
        ...
        if (pstFile.pstFileType == PSTFile_class_1.PSTFile.PST_TYPE_ANSI) {
          ...
          this._offsetIndexIdentifier = PSTUtil_class_1.PSTUtil.convertLittleEndianBytesToLong(data, offset + 4, offset + 8).toNumber() & 4294967294;
          if (entryType == PSTFile_class_1.PSTFile.SLBLOCK_ENTRY) {
            this._subNodeOffsetIndexIdentifier = PSTUtil_class_1.PSTUtil.convertLittleEndianBytesToLong(data, offset + 8, offset + 12).toNumber() & 4294967294;
          } else {
            this._subNodeOffsetIndexIdentifier = 0;
          }
        } else {
          this._descriptorIdentifier = PSTUtil_class_1.PSTUtil.convertLittleEndianBytesToLong(data, offset, offset + 4).toNumber();
          this._offsetIndexIdentifier = PSTUtil_class_1.PSTUtil.convertLittleEndianBytesToLong(data, offset + 8, offset + 16).toNumber() & 4294967294;
          if (entryType == PSTFile_class_1.PSTFile.SLBLOCK_ENTRY) {
            this._subNodeOffsetIndexIdentifier = PSTUtil_class_1.PSTUtil.convertLittleEndianBytesToLong(data, offset + 16, offset + 24).toNumber() & 4294967294;
          } else {
            this._subNodeOffsetIndexIdentifier = 0;
          }
        }
      ...
      getBlockOffsets() {
        ...
        const offsets = this._pstFile.readLeaf(long_1.default.fromNumber(this.offsetIndexIdentifier)).getBlockOffsets();
        const offsetsOut = [];
...
// node_modules/pst-extractor/dist/OffsetIndexItem.class.js
var require_OffsetIndexItem_class = __commonJS({
  "node_modules/pst-extractor/dist/OffsetIndexItem.class.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OffsetIndexItem = void 0;
    var PSTFile_class_1 = require_PSTFile_class();
    var PSTUtil_class_1 = require_PSTUtil_class();
    var OffsetIndexItem = class {
      get indexIdentifier() {
...
// node_modules/pst-extractor/dist/PSTNodeInputStream.class.js
var require_PSTNodeInputStream_class = __commonJS({
  "node_modules/pst-extractor/dist/PSTNodeInputStream.class.js"(exports) {
    "use strict";
    ...
    var PSTDescriptorItem_class_1 = require_PSTDescriptorItem_class();
    var PSTUtil_class_1 = require_PSTUtil_class();
    var OffsetIndexItem_class_1 = require_OffsetIndexItem_class();
    var PSTFile_class_1 = require_PSTFile_class();
    var PSTNodeInputStream = class {
      get currentLocation() {
      ...
      constructor(pstFile, arg, encrypted) {
        ...
        if (arg instanceof OffsetIndexItem_class_1.OffsetIndexItem) {
          this._encrypted = pstFile.encryptionType == PSTFile_class_1.PSTFile.ENCRYPTION_TYPE_COMPRESSIBLE;
      ...
      detectZlib() {
        ...
        try {
          if (this.read() === 120 && this.read() === 156) {
            ...
            this.currentLocation = long_1.default.ZERO;
            this.currentBlock = 0;
            this._length = this.allData ? long_1.default.fromNumber(this.allData.length) : long_1.default.ZERO;
          }
          this.seek(long_1.default.ZERO);
        } catch (err) {
      ...
      loadFromOffsetItem(offsetItem) {
        let bInternal = (offsetItem.indexIdentifier.toNumber() & 2) != 0;
      ...
      readSingleByte() {
        if (this.allData != null) {
          ...
          let value = this.allData[this.currentLocation.toNumber()] & 255;
      ...
      readBlock(output) {
        ...
        if (this.allData != null) {
          const bytesRemaining = this.length.subtract(this.currentLocation).toNumber();
        ...
        while (!filled) {
          ...
          const currentPosInBlock = this.currentLocation.subtract(skipPoint).toNumber();
...
// node_modules/pst-extractor/dist/NodeInfo.class.js
var require_NodeInfo_class = __commonJS({
  "node_modules/pst-extractor/dist/NodeInfo.class.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/pst-extractor/dist/PSTTable.class.js
var require_PSTTable_class = __commonJS({
  "node_modules/pst-extractor/dist/PSTTable.class.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var long_1 = __importDefault(require_umd());
    var NodeInfo_class_1 = require_NodeInfo_class();
    var PSTNodeInputStream_class_1 = require_PSTNodeInputStream_class();
    var PSTTable = class {
      /**
      ...
      constructor(pstNodeInputStream, subNodeDescriptorItems) {
        ...
        this.subNodeDescriptorItems = /* @__PURE__ */ new Map();
        ...
        this.hidUserRoot = pstNodeInputStream.seekAndReadLong(long_1.default.fromValue(4), 4).toNumber();
        const headerNodeInfo = this.getNodeInfo(32);
        if (!headerNodeInfo) {
        ...
        let headerByte = headerNodeInfo.pstNodeInputStream.read() & 255;
        if (headerByte != 181) {
          headerNodeInfo.pstNodeInputStream.seek(long_1.default.fromValue(headerNodeInfo.startOffset));
          headerByte = headerNodeInfo.pstNodeInputStream.read() & 255;
          headerNodeInfo.pstNodeInputStream.seek(long_1.default.fromValue(headerNodeInfo.startOffset));
        ...
        this.sizeOfItemKey = headerNodeInfo.pstNodeInputStream.read() & 255;
        this.sizeOfItemValue = headerNodeInfo.pstNodeInputStream.read() & 255;
        this.numberOfIndexLevels = headerNodeInfo.pstNodeInputStream.read() & 255;
        this.hidRoot = headerNodeInfo.seekAndReadLong(long_1.default.fromValue(4), 4).toNumber();
      }
      /**
       * Release data.
       * @protected
      ...
      getNodeInfo(hnid) {
        ...
        const index = (hnid & 65535) >> 5;
        let blockOffset = 0;
        if (whichBlock > 0) {
          blockOffset = this.arrayBlocks[whichBlock - 1].toNumber();
        }
        let iHeapNodePageMap = this.pstNodeInputStream.seekAndReadLong(long_1.default.fromValue(blockOffset), 2).toNumber() + blockOffset;
        const cAlloc = this.pstNodeInputStream.seekAndReadLong(long_1.default.fromValue(iHeapNodePageMap), 2).toNumber();
        if (index >= cAlloc + 1) {
          throw new Error("PSTTable::getNodeInfo: node index doesn't exist! nid = " + hnid);
        }
        iHeapNodePageMap += 2 * index + 2;
        const start = this.pstNodeInputStream.seekAndReadLong(long_1.default.fromValue(iHeapNodePageMap), 2).toNumber() + blockOffset;
        const end = this.pstNodeInputStream.seekAndReadLong(long_1.default.fromValue(iHeapNodePageMap + 2), 2).toNumber() + blockOffset;
...
// node_modules/pst-extractor/dist/PSTTableItem.class.js
var require_PSTTableItem_class = __commonJS({
  "node_modules/pst-extractor/dist/PSTTableItem.class.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var long_1 = __importDefault(require_umd());
    var PSTUtil_class_1 = require_PSTUtil_class();
    var PSTTableItem = class _PSTTableItem {
      constructor() {
        this._itemIndex = 0;
      ...
      getStringValue(stringType) {
        ...
        if (stringType === _PSTTableItem.VALUE_TYPE_PT_UNICODE) {
          try {
        ...
        if (stringType == _PSTTableItem.VALUE_TYPE_PT_STRING8) {
    ...
    PSTTableItem.VALUE_TYPE_PT_UNICODE = 31;
    PSTTableItem.VALUE_TYPE_PT_STRING8 = 30;
    PSTTableItem.VALUE_TYPE_PT_BIN = 258;
  }
});

// node_modules/pst-extractor/dist/PSTTableBC.class.js
var require_PSTTableBC_class = __commonJS({
  "node_modules/pst-extractor/dist/PSTTableBC.class.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var long_1 = __importDefault(require_umd());
    var PSTTable_class_1 = require_PSTTable_class();
    var PSTTableItem_class_1 = require_PSTTableItem_class();
    var PSTUtil_class_1 = require_PSTUtil_class();
    var PSTTableBC = class extends PSTTable_class_1.PSTTable {
      /**
      ...
      constructor(pstNodeInputStream) {
        super(pstNodeInputStream, /* @__PURE__ */ new Map());
        ...
        for (let x = 0; x < this.numberOfKeys; x++) {
          ...
          switch (item.entryValueType) {
            case 2:
              item.entryValueReference &= 65535;
            case 3:
            // 32bit integer
            case 10:
            // 32bit error code
...
// node_modules/pst-extractor/dist/PSTObject.class.js
var require_PSTObject_class = __commonJS({
  "node_modules/pst-extractor/dist/PSTObject.class.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var long_1 = __importDefault(require_umd());
    var OutlookProperties_1 = require_OutlookProperties();
    var PSTNodeInputStream_class_1 = require_PSTNodeInputStream_class();
    var PSTTableBC_class_1 = require_PSTTableBC_class();
    var PSTUtil_class_1 = require_PSTUtil_class();
    var PSTObject = class {
      /**
      ...
      getNodeType(descriptorIdentifier) {
        if (descriptorIdentifier) {
          return descriptorIdentifier & 31;
        } else if (this.descriptorIndexNode) {
          return this.descriptorIndexNode.descriptorIdentifier & 31;
        } else {
          return -1;
        }
      }
      ...
      getLongItem(identifier, defaultValue) {
        ...
        if (this.pstTableItems && this.pstTableItems.has(identifier)) {
          const item = this.pstTableItems.get(identifier);
          if (item && item.entryValueType == 3) {
            return long_1.default.fromNumber(item.entryValueReference);
          } else if (item && item.entryValueType == 20) {
      ...
      getStringItem(identifier, stringType, codepage) {
        ...
        const item = this.pstTableItems ? this.pstTableItems.get(identifier) : void 0;
        if (item) {
          if (!codepage) {
       ...
       */
      get stringCodepage() {
        let cpItem = this.pstTableItems ? this.pstTableItems.get(16381) : null;
        if (cpItem == null) {
          cpItem = this.pstTableItems ? this.pstTableItems.get(16350) : null;
        }
        if (cpItem != null) {
      ...
      getBinaryItem(identifier) {
        if (this.pstTableItems && this.pstTableItems.has(identifier)) {
          const item = this.pstTableItems.get(identifier);
          if (item && item.entryValueType == 258) {
            if (!item.isExternalValueReference) {
              return item.data;
            }
            if (this.localDescriptorItems != null && this.localDescriptorItems.has(item.entryValueReference)) {
...
// node_modules/pst-extractor/dist/ColumnDescriptor.class.js
var require_ColumnDescriptor_class = __commonJS({
  "node_modules/pst-extractor/dist/ColumnDescriptor.class.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var ColumnDescriptor = class {
      ...
      constructor(nodeInfo, offset) {
        this._type = nodeInfo.seekAndReadLong(long_1.default.fromValue(offset), 2).toNumber();
        this._id = nodeInfo.seekAndReadLong(long_1.default.fromValue(offset + 2), 2).toNumber();
        this._ibData = nodeInfo.seekAndReadLong(long_1.default.fromValue(offset + 4), 2).toNumber();
        this._cbData = nodeInfo.pstNodeInputStream.read();
        this._iBit = nodeInfo.pstNodeInputStream.read();
      }
      /**
       * JSON stringify the object properties.
       * @returns {string}
...
// node_modules/pst-extractor/dist/PSTTable7C.class.js
var require_PSTTable7C_class = __commonJS({
  "node_modules/pst-extractor/dist/PSTTable7C.class.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var PSTTable_class_1 = require_PSTTable_class();
    var PSTTableItem_class_1 = require_PSTTableItem_class();
    var ColumnDescriptor_class_1 = require_ColumnDescriptor_class();
    var PSTTable7C = class extends PSTTable_class_1.PSTTable {
      /**
      ...
      constructor(pstNodeInputStream, subNodeDescriptorItems, entityToExtract) {
        ...
        let offset = 0;
        this.numColumns = tcHeaderNode.seekAndReadLong(long_1.default.fromNumber(offset + 1), 1).toNumber();
        const TCI_4b = tcHeaderNode.seekAndReadLong(long_1.default.fromNumber(offset + 2), 2).toNumber();
        const TCI_2b = tcHeaderNode.seekAndReadLong(long_1.default.fromNumber(offset + 4), 2).toNumber();
        this.TCI_1b = tcHeaderNode.seekAndReadLong(long_1.default.fromNumber(offset + 6), 2).toNumber();
        this.TCI_bm = tcHeaderNode.seekAndReadLong(long_1.default.fromNumber(offset + 8), 2).toNumber();
        const hidRowIndex = tcHeaderNode.seekAndReadLong(long_1.default.fromNumber(offset + 10), 4).toNumber();
        const hnidRows = tcHeaderNode.seekAndReadLong(long_1.default.fromNumber(offset + 14), 4).toNumber();
        offset += 22;
        ...
        offset = 0;
        for (let x = 0; x < this.numberOfKeys; x++) {
          const context = keyTableInfo.seekAndReadLong(long_1.default.fromNumber(offset), this.sizeOfItemKey).toNumber();
          offset += this.sizeOfItemKey;
          const rowIndex = keyTableInfo.seekAndReadLong(long_1.default.fromNumber(offset), this.sizeOfItemValue).toNumber();
      ...
      getItems(startAtRecord, numberOfRecordsToReturn) {
        ...
        const blockPadding = this.BLOCK_SIZE - numberOfRowsPerBlock * this.TCI_bm;
        this.numberOfDataSets = Math.trunc(numberOfBlocks * numberOfRowsPerBlock + this.rowNodeInfo.length() % this.BLOCK_SIZE / this.TCI_bm);
        if (startAtRecord === void 0) {
          numberOfRecordsToReturn = this.numberOfDataSets;
          startAtRecord = 0;
          setLocalList = true;
        }
        if (numberOfRecordsToReturn === void 0) {
        ...
        for (let rowCounter = 0; rowCounter < numberOfRecordsToReturn; rowCounter++) {
          const currentItem = /* @__PURE__ */ new Map();
          if (this.rowNodeInfo.pstNodeInputStream.pstFile.pstFileType == PSTFile_class_1.PSTFile.PST_TYPE_ANSI) {
          ...
          item.entryType = long_1.default.fromNumber(26610);
          ...
          while (col < this.numColumns) {
            ...
            switch (this.columnDescriptors[col].cbData) {
              case 1:
                item.entryValueReference = this.rowNodeInfo.seekAndReadLong(long_1.default.fromNumber(currentValueArrayStart + this.columnDescriptors[col].ibData), 1).toNumber() & 255;
                item.isExternalValueReference = true;
                break;
              case 2:
                item.entryValueReference = this.rowNodeInfo.seekAndReadLong(long_1.default.fromNumber(currentValueArrayStart + this.columnDescriptors[col].ibData), 2).toNumber() & 65535;
                item.isExternalValueReference = true;
                break;
              case 8:
                item.data = Buffer.alloc(8);
                this.rowNodeInfo.pstNodeInputStream.seek(long_1.default.fromNumber(this.rowNodeInfo.startOffset + currentValueArrayStart + this.columnDescriptors[col].ibData));
                this.rowNodeInfo.pstNodeInputStream.readCompletely(item.data);
                break;
              default:
                item.entryValueReference = this.rowNodeInfo.seekAndReadLong(long_1.default.fromNumber(currentValueArrayStart + this.columnDescriptors[col].ibData), 4).toNumber();
                if (this.columnDescriptors[col].type == 3 || this.columnDescriptors[col].type == 4 || this.columnDescriptors[col].type == 10) {
                  item.isExternalValueReference = true;
                  break;
                }
                if ((item.entryValueReference & 31) != 0) {
                  item.isExternalValueReference = true;
                  break;
                }
...
// node_modules/pst-extractor/dist/LZFu.class.js
var require_LZFu_class = __commonJS({
  "node_modules/pst-extractor/dist/LZFu.class.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.LZFu = void 0;
    var PSTUtil_class_1 = require_PSTUtil_class();
    var LZFu = class _LZFu {
      /**
      ...
      static decode(data) {
        ...
        if (compressionSig == 1967544908) {
          ...
          try {
            const bytes = Buffer.from(_LZFu.LZFU_HEADER);
            PSTUtil_class_1.PSTUtil.arraycopy(bytes, 0, lzBuffer, 0, _LZFu.LZFU_HEADER.length);
          } catch (err) {
            console.error("LZFu::decode cant preload buffer\n" + err);
            throw err;
          }
          let bufferPosition = _LZFu.LZFU_HEADER.length;
          let currentDataPosition = 16;
          while (currentDataPosition < data.length - 2 && outputPosition < output.length) {
            let flags = data[currentDataPosition++] & 255;
            for (let x = 0; x < 8 && outputPosition < output.length; x++) {
              const isRef = (flags & 1) == 1;
              flags >>= 1;
              if (isRef) {
                const refOffsetOrig = data[currentDataPosition++] & 255;
                const refSizeOrig = data[currentDataPosition++] & 255;
                const refOffset = refOffsetOrig << 4 | refSizeOrig >>> 4;
                const refSize = (refSizeOrig & 15) + 2;
                try {
                  let index = refOffset;
        ...
        } else if (compressionSig == 1095517517) {
...
// node_modules/pst-extractor/dist/PSTAttachment.class.js
var require_PSTAttachment_class = __commonJS({
  "node_modules/pst-extractor/dist/PSTAttachment.class.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var OutlookProperties_1 = require_OutlookProperties();
    var PSTNodeInputStream_class_1 = require_PSTNodeInputStream_class();
    var PSTObject_class_1 = require_PSTObject_class();
    var PSTTableBC_class_1 = require_PSTTableBC_class();
    var PSTUtil_class_1 = require_PSTUtil_class();
    var PSTAttachment = class _PSTAttachment extends PSTObject_class_1.PSTObject {
      /**
      ...
      get embeddedPSTMessage() {
        ...
        if (this.getIntItem(14085) == _PSTAttachment.ATTACHMENT_METHOD_EMBEDDED) {
          const item = this.pstTableItems ? this.pstTableItems.get(14081) : null;
          if (item && item.entryValueType == 258) {
            if (!item.isExternalValueReference) {
          ...
          } else if (item && item.entryValueType == 13) {
            const descriptorItem = PSTUtil_class_1.PSTUtil.convertLittleEndianBytesToLong(item.data, 0, 4).toNumber();
            const descriptorItemNested = this.localDescriptorItems ? this.localDescriptorItems.get(descriptorItem) : null;
       ...
       */
      get fileInputStream() {
        const attachmentDataObject = this.pstTableItems ? this.pstTableItems.get(OutlookProperties_1.OutlookProperties.PR_ATTACH_DATA_BIN) : null;
        if (!attachmentDataObject) {
          return null;
        } else if (attachmentDataObject.isExternalValueReference) {
          const descriptorItemNested = this.localDescriptorItems ? this.localDescriptorItems.get(attachmentDataObject.entryValueReference) : null;
          if (descriptorItemNested) {
...
// node_modules/pst-extractor/dist/PSTRecipient.class.js
var require_PSTRecipient_class = __commonJS({
  "node_modules/pst-extractor/dist/PSTRecipient.class.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.PSTRecipient = void 0;
    var OutlookProperties_1 = require_OutlookProperties();
    var PSTObject_class_1 = require_PSTObject_class();
    var PSTRecipient = class extends PSTObject_class_1.PSTObject {
      /**
      ...
      constructor(pstFile, recipientDetails) {
        super(pstFile, void 0, recipientDetails);
      }
      /**
...
var require_PSTMessage_class = __commonJS({
  "node_modules/pst-extractor/dist/PSTMessage.class.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var PSTNodeInputStream_class_1 = require_PSTNodeInputStream_class();
    var PSTObject_class_1 = require_PSTObject_class();
    var PSTTable7C_class_1 = require_PSTTable7C_class();
    var PSTTableBC_class_1 = require_PSTTableBC_class();
    var PSTUtil_class_1 = require_PSTUtil_class();
    var LZFu_class_1 = require_LZFu_class();
    var PSTAttachment_class_1 = require_PSTAttachment_class();
    var PSTRecipient_class_1 = require_PSTRecipient_class();
    var PidTagMessageFlags;
    (function(PidTagMessageFlags2) {
      PidTagMessageFlags2[PidTagMessageFlags2["MSGFLAG_READ"] = 1] = "MSGFLAG_READ";
      PidTagMessageFlags2[PidTagMessageFlags2["MSGFLAG_UNMODIFIED"] = 2] = "MSGFLAG_UNMODIFIED";
      PidTagMessageFlags2[PidTagMessageFlags2["MSGFLAG_SUBMIT"] = 4] = "MSGFLAG_SUBMIT";
      PidTagMessageFlags2[PidTagMessageFlags2["MSGFLAG_UNSENT"] = 8] = "MSGFLAG_UNSENT";
      PidTagMessageFlags2[PidTagMessageFlags2["MSGFLAG_HASATTACH"] = 16] = "MSGFLAG_HASATTACH";
      PidTagMessageFlags2[PidTagMessageFlags2["MSGFLAG_FROMME"] = 32] = "MSGFLAG_FROMME";
      PidTagMessageFlags2[PidTagMessageFlags2["MSGFLAG_ASSOCIATED"] = 64] = "MSGFLAG_ASSOCIATED";
      PidTagMessageFlags2[PidTagMessageFlags2["MSGFLAG_RESEND"] = 128] = "MSGFLAG_RESEND";
    })(PidTagMessageFlags || (PidTagMessageFlags = {}));
    var PSTMessage2 = class _PSTMessage extends PSTObject_class_1.PSTObject {
      /**
       ...
       */
      get isRead() {
        return (this.getIntItem(OutlookProperties_1.OutlookProperties.PR_MESSAGE_FLAGS) & PidTagMessageFlags.MSGFLAG_READ) != 0;
      }
      /**
       ...
       */
      get isUnmodified() {
        return (this.getIntItem(OutlookProperties_1.OutlookProperties.PR_MESSAGE_FLAGS) & PidTagMessageFlags.MSGFLAG_UNMODIFIED) != 0;
      }
      /**
       ...
       */
      get isSubmitted() {
        return (this.getIntItem(OutlookProperties_1.OutlookProperties.PR_MESSAGE_FLAGS) & PidTagMessageFlags.MSGFLAG_SUBMIT) != 0;
      }
      /**
       ...
       */
      get isUnsent() {
        return (this.getIntItem(OutlookProperties_1.OutlookProperties.PR_MESSAGE_FLAGS) & PidTagMessageFlags.MSGFLAG_UNSENT) != 0;
      }
      /**
       ...
       */
      get hasAttachments() {
        return (this.getIntItem(OutlookProperties_1.OutlookProperties.PR_MESSAGE_FLAGS) & PidTagMessageFlags.MSGFLAG_HASATTACH) != 0;
      }
      /**
       ...
       */
      get isFromMe() {
        return (this.getIntItem(OutlookProperties_1.OutlookProperties.PR_MESSAGE_FLAGS) & PidTagMessageFlags.MSGFLAG_FROMME) != 0;
      }
      /**
       ...
       */
      get isAssociated() {
        return (this.getIntItem(OutlookProperties_1.OutlookProperties.PR_MESSAGE_FLAGS) & PidTagMessageFlags.MSGFLAG_ASSOCIATED) != 0;
      }
      /**
       ...
       */
      get isResent() {
        return (this.getIntItem(OutlookProperties_1.OutlookProperties.PR_MESSAGE_FLAGS) & PidTagMessageFlags.MSGFLAG_RESEND) != 0;
      }
      /*
            Recipients
        */
      ...
      processRecipients() {
        try {
          ...
          if (this.recipientTable == null && this.localDescriptorItems != null && this.localDescriptorItems.has(recipientTableKey)) {
            ...
            let descriptorItems = /* @__PURE__ */ new Map();
      ...
      getRecipient(recipientNumber) {
        ...
        return recipientDetails ? new PSTRecipient_class_1.PSTRecipient(this.pstFile, recipientDetails) : null;
      }
      /**
       ...
       */
      get bodyRTF() {
        if (this.pstTableItems && this.pstTableItems.has(4105)) {
          const item = this.pstTableItems.get(4105);
          if (item && item.data.length > 0) {
            return LZFu_class_1.LZFu.decode(item.data);
          }
          const ref = item ? item.entryValueReference : null;
          if (ref) {
            const descItem = this.localDescriptorItems ? this.localDescriptorItems.get(ref) : null;
            if (descItem != null) {
       ...
       */
      getCodepage() {
        let cpItem = this.pstTableItems ? this.pstTableItems.get(OutlookProperties_1.OutlookProperties.PR_INTERNET_CPID) : null;
        if (cpItem == null) {
          cpItem = this.pstTableItems ? this.pstTableItems.get(OutlookProperties_1.OutlookProperties.PR_MESSAGE_CODEPAGE) : null;
        }
        if (cpItem != null) {
          return PSTUtil_class_1.PSTUtil.getInternetCodePageCharset(cpItem.entryValueReference);
        }
      ...
      getAttachment(attachmentNumber) {
        ...
        const attachmentTableItem = attachmentDetails.get(26610);
        ...
        if (attachmentData != null && attachmentData.length > 0) {
          ...
          let attachmentDescriptorItems = /* @__PURE__ */ new Map();
        ...
        throw new Error("PSTMessage::getAttachment unable to fetch attachment number " + attachmentNumber + ", unable to read attachment details table");
      }
      /*
       ...
       */
      get importance() {
        return this.getIntItem(OutlookProperties_1.OutlookProperties.PR_IMPORTANCE, _PSTMessage.IMPORTANCE_NORMAL);
      }
      /**
      ...
      get subject() {
        ...
        if (subject != null && subject.length >= 2 && subject.charCodeAt(0) == 1) {
          if (subject.length == 2) {
            subject = "";
          } else {
      ...
      get recipientReassignmentProhibited() {
        return this.getIntItem(OutlookProperties_1.OutlookProperties.PR_RECIPIENT_REASSIGNMENT_PROHIBITED) != 0;
      }
      /**
            ...
            if (item) {
              ...
              if (categoryCount > 0) {
                ...
                for (let x = 0; x < offsets.length - 1; x++) {
                  const start2 = offsets[x];
                  const end2 = offsets[x + 1];
                  const length2 = end2 - start2;
                  const buf2 = Buffer.alloc(length2);
                  PSTUtil_class_1.PSTUtil.arraycopy(item.data, start2, buf2, 0, length2);
                  const name2 = Buffer.from(buf2).toString();
                  categories2[x] = name2;
                }
                ...
                categories2[categories2.length - 1] = name;
              }
            }
          } catch (err) {
    ...
    exports.PSTMessage = PSTMessage2;
    PSTMessage2.IMPORTANCE_LOW = 0;
    PSTMessage2.IMPORTANCE_NORMAL = 1;
    PSTMessage2.IMPORTANCE_HIGH = 2;
    PSTMessage2.RECIPIENT_TYPE_TO = 1;
    PSTMessage2.RECIPIENT_TYPE_CC = 2;
  }
});

// node_modules/pst-extractor/dist/PSTAppointment.class.js
var require_PSTAppointment_class = __commonJS({
  "node_modules/pst-extractor/dist/PSTAppointment.class.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.PSTAppointment = void 0;
    var OutlookProperties_1 = require_OutlookProperties();
    var PSTMessage_class_1 = require_PSTMessage_class();
    var PSTAppointment = class extends PSTMessage_class_1.PSTMessage {
...
// node_modules/pst-extractor/dist/PSTContact.class.js
var require_PSTContact_class = __commonJS({
  "node_modules/pst-extractor/dist/PSTContact.class.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.PSTContact = void 0;
    var OutlookProperties_1 = require_OutlookProperties();
    var PSTMessage_class_1 = require_PSTMessage_class();
    var PSTContact = class extends PSTMessage_class_1.PSTMessage {
      constructor(pstFile, descriptorIndexNode, table, localDescriptorItems) {
        super(pstFile, descriptorIndexNode, table, localDescriptorItems);
      }
      /**
...
// node_modules/pst-extractor/dist/PSTFolder.class.js
var require_PSTFolder_class = __commonJS({
  "node_modules/pst-extractor/dist/PSTFolder.class.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var PSTObject_class_1 = require_PSTObject_class();
    var PSTUtil_class_1 = require_PSTUtil_class();
    var PSTFolder2 = class extends PSTObject_class_1.PSTObject {
      /**
      ...
      initEmailsTable() {
        ...
        try {
          ...
          const offsetIndexItem = this.pstFile.getOffsetIndexNode(folderDescriptor.dataOffsetIndexIdentifier);
          const pstNodeInputStream = new PSTNodeInputStream_class_1.PSTNodeInputStream(this.pstFile, offsetIndexItem);
          this.emailsTable = new PSTTable7C_class_1.PSTTable7C(pstNodeInputStream, tmp, 26610);
        } catch (err) {
          ...
          if (allChildren) {
            for (const node of allChildren) {
              if (node != null && this.getNodeType(node.descriptorIdentifier) == PSTUtil_class_1.PSTUtil.NID_TYPE_NORMAL_MESSAGE) {
      ...
      getNextChild() {
        ...
        if (this.emailsTable) {
          ...
          const emailRow = rows[0].get(26610);
    ...
    exports.PSTFolder = PSTFolder2;
  }
});

// node_modules/pst-extractor/dist/RecurrencePattern.class.js
var require_RecurrencePattern_class = __commonJS({
  "node_modules/pst-extractor/dist/RecurrencePattern.class.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var EndType;
    (function(EndType2) {
      EndType2[EndType2["AfterDate"] = 8225] = "AfterDate";
      EndType2[EndType2["AfterNOccurrences"] = 8226] = "AfterNOccurrences";
      EndType2[EndType2["NeverEnd"] = 8227] = "NeverEnd";
    })(EndType || (exports.EndType = EndType = {}));
    var NthOccurrence;
    (function(NthOccurrence2) {
      NthOccurrence2[NthOccurrence2["First"] = 1] = "First";
      NthOccurrence2[NthOccurrence2["Second"] = 2] = "Second";
      NthOccurrence2[NthOccurrence2["Third"] = 3] = "Third";
      NthOccurrence2[NthOccurrence2["Fourth"] = 4] = "Fourth";
      NthOccurrence2[NthOccurrence2["Last"] = 5] = "Last";
    })(NthOccurrence || (exports.NthOccurrence = NthOccurrence = {}));
    var RecurrencePattern = class {
      constructor(buffer) {
        this.buffer = buffer;
    ...
    function winToJsDate(dateInt) {
      return new Date(dateInt * 60 * 1e3 - 116444736e5);
    }
...
// node_modules/pst-extractor/dist/PSTTask.class.js
var require_PSTTask_class = __commonJS({
  "node_modules/pst-extractor/dist/PSTTask.class.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var PSTMessage_class_1 = require_PSTMessage_class();
    var PSTFile_class_1 = require_PSTFile_class();
    var RecurrencePattern_class_1 = require_RecurrencePattern_class();
    var PSTTask = class extends PSTMessage_class_1.PSTMessage {
      /**
...
// node_modules/pst-extractor/dist/PSTActivity.class.js
var require_PSTActivity_class = __commonJS({
  "node_modules/pst-extractor/dist/PSTActivity.class.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.PSTActivity = void 0;
    var PSTMessage_class_1 = require_PSTMessage_class();
    var OutlookProperties_1 = require_OutlookProperties();
    var PSTActivity = class extends PSTMessage_class_1.PSTMessage {
      /**
...
var require_PSTUtil_class = __commonJS({
  "node_modules/pst-extractor/dist/PSTUtil.class.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var long_1 = __importDefault(require_umd());
    var PSTAppointment_class_1 = require_PSTAppointment_class();
    var PSTContact_class_1 = require_PSTContact_class();
    var PSTFolder_class_1 = require_PSTFolder_class();
    var PSTMessage_class_1 = require_PSTMessage_class();
    var PSTNodeInputStream_class_1 = require_PSTNodeInputStream_class();
    var PSTTableBC_class_1 = require_PSTTableBC_class();
    var PSTTask_class_1 = require_PSTTask_class();
    var PSTActivity_class_1 = require_PSTActivity_class();
    var iconv_lite_1 = __importDefault(require_lib());
    var PSTUtil = class {
      /**
      ...
      static convertLittleEndianBytesToLong(data, start, end) {
        ...
        let offset = long_1.default.fromNumber(data[end - 1] & 255);
        let tmpLongValue;
        for (let x = end - 2; x >= start; x--) {
          offset = offset.shiftLeft(8);
          tmpLongValue = long_1.default.fromNumber(data[x] & 255);
      ...
      static convertBigEndianBytesToLong(data, start, end) {
        ...
        for (let x = start; x < end; ++x) {
          offset = offset.shiftLeft(8);
          const tmpLongValue = long_1.default.fromNumber(data[x] & 255);
          offset = offset.xor(tmpLongValue);
        }
        return offset;
      }
      ...
      static detectAndLoadPSTObject(theFile, arg) {
        ...
        const nidType = folderIndexNode.descriptorIdentifier & 31;
        if (nidType == 2 || nidType == 3 || nidType == 4) {
          ...
          let localDescriptorItems = void 0;
      ...
      static createAppropriatePSTMessageObject(theFile, folderIndexNode, table, localDescriptorItems) {
        const item = table.getItems().get(26);
        let messageClass = "";
        if (item != null) {
      ...
      static filetimeToDate(hi, low) {
        ...
        const l = low.and(4294967295);
        const filetime = h.or(l);
        const msSince16010101 = filetime.divide(1e3 * 10);
    ...
    PSTUtil.codePages = /* @__PURE__ */ new Map([
      [28596, "iso-8859-6"],
      [1256, "windows-1256"],
      [28594, "iso-8859-4"],
      [1257, "windows-1257"],
    ...
    PSTUtil.propertyName = /* @__PURE__ */ new Map([
      [2, "PidTagAlternateRecipientAllowed"],
      [3, "PidTagNameidStreamEntry"],
      [4, "PidTagNameidStreamString"],
      [23, "PidTagImportance"],
      [26, "PidTagMessageClass"],
      [35, "PidTagOriginatorDeliveryReportRequested"],
      [38, "PidTagPriority"],
      [41, "PidLidOldWhenStartWhole"],
      [43, "PidTagRecipientReassignmentProhibited"],
      [46, "PidTagOriginalSensitivity"],
      [54, "PidTagSensitivity"],
      [55, "PidTagSubject"],
      [57, "PidTagClientSubmitTime"],
      [59, "PidTagSentRepresentingSearchKey"],
      [63, "PidTagReceivedByEntryId"],
      [64, "PidTagReceivedByName"],
      [65, "PidTagSentRepresentingEntryId"],
      [66, "PidTagSentRepresentingName"],
      [67, "PidTagReceivedRepresentingEntryId"],
      [68, "PidTagReceivedRepresentingName"],
      [77, "PidTagOriginalAuthorName"],
      [82, "PidTagReceivedRepresentingSearchKey"],
      [87, "PidTagMessageToMe"],
      [88, "PidTagMessageCcMe"],
      [96, "PidTagStartDate"],
      [97, "PidTagEndDate"],
      [98, "PidTagOwnerAppointmentId"],
      [99, "PidTagResponseRequested"],
      [100, "PidTagSentRepresentingAddressType"],
      [101, "PidTagSentRepresentingEmailAddress"],
      [112, "PidTagConversationTopic"],
      [113, "PidTagConversationIndex"],
      [117, "PidTagReceivedByAddressType"],
      [118, "PidTagReceivedByEmailAddress"],
      [119, "PidTagReceivedRepresentingAddressType"],
      [120, "PidTagReceivedRepresentingEmailAddress"],
      [125, "PidTagTransportMessageHeaders"],
      [3093, "PidTagRecipientType"],
      [3095, "PidTagReplyRequested"],
      [3097, "PidTagSenderEntryId"],
      [3098, "PidTagSenderName"],
      [3101, "PidTagSenderSearchKey"],
      [3102, "PidTagSenderAddressType"],
      [3103, "PidTagSenderEmailAddress"],
      [3585, "PidTagDeleteAfterSubmit"],
      [3586, "PidTagDisplayBcc"],
      [3587, "PidTagDisplayCc"],
      [3588, "PidTagDisplayTo"],
      [3590, "PidTagMessageDeliveryTime"],
      [3591, "PidTagMessageFlags"],
      [3592, "PidTagMessageSize"],
      [3599, "PidTagResponsibility"],
      [3616, "PidTagAttachSize"],
      [3619, "PidTagInternetArticleNumber"],
      [3640, "PidTagReplFlags"],
      [3682, "PidTagUrlCompNameSet"],
      [3705, "PidTagTrustSender"],
      [4089, "PidTagRecordKey"],
      [4094, "PidTagObjectType"],
      [4095, "PidTagEntryId"],
      [4096, "PidTagBody"],
      [4105, "PidTagRtfCompressed"],
      [4115, "PidTagBodyHtml"],
      [4149, "PidTagInternetMessageId"],
      [4153, "PidTagInternetReferences"],
      [4162, "PidTagInReplyToId"],
      [4224, "PidTagIconIndex"],
      [4225, "PidTagLastVerbExecuted"],
      [4226, "PidTagLastVerbExecutionTime"],
      [4246, "PidTagBlockStatus"],
      [4291, "PidTagICalendarStartTime"],
      [4292, "PidTagICalendarEndTime"],
      [4338, "Unknown_10F2"],
      [4339, "PidTagUrlCompName"],
      [4340, "PidTagAttributeHidden"],
      [4341, "PidTagAttributeSystem"],
      [4342, "PidTagAttributeReadOnly"],
      [12289, "PidTagDisplayName"],
      [12290, "PidTagAddressType"],
      [12291, "PidTagEmailAddress"],
      [12295, "PidTagCreationTime"],
      [12296, "PidTagLastModificationTime"],
      [12299, "PidTagSearchKey"],
      [14081, "PidTagAttachDataBinary"],
      [14082, "PidTagAttachEncoding"],
      [14083, "PidTagAttachExtension"],
      [14084, "PidTagAttachFilename"],
      [14085, "PidTagAttachMethod"],
      [14089, "PidTagAttachRendering"],
      [14091, "PidTagRenderingPosition"],
      [14094, "PidTagAttachMimeTag"],
      [14090, "PidTagAttachTag"],
      [14098, "PidTagAttachContentId"],
      [14100, "PidTagAttachFlags"],
      [14592, "PidTagDisplayType"],
      [14846, "PidTagPrimarySmtpAddress"],
      [14847, "PidTag7BitDisplayName"],
      [14848, "PidTagAccount"],
      [14856, "PidTagBusinessTelephoneNumber"],
      [14880, "PidTagTransmittableDisplayName"],
      [14912, "PidTagSendRichInfo"],
      [14960, "PidTagUserX509Certificate"],
      [14961, "PidTagSendInternetEncoding"],
      [16350, "PidTagInternetCodepage"],
      [16369, "PidTagMessageLocaleId"],
      [16381, "PidTagMessageCodepage"],
      [16377, "PidTagCreatorName"],
      [16409, "PidTagSenderFlags"],
      [16410, "PidTagSentRepresentingFlags"],
      [16411, "PidTagReceivedByFlags"],
      [16412, "PidTagReceivedRepresentingFlags"],
      [16446, "Unknown_403E"],
      [18952, "Unknown_4A08"],
      [22786, "PidTagInternetMailOverrideFormat"],
      [22793, "PidTagMessageEditorFormat"],
      [24542, "PidTagRecipientResourceState"],
      [24543, "PidTagRecipientOrder"],
      [24555, "Unknown_5FEB"],
      [24559, "Unknown_5FEF"],
      [24562, "Unknown_5FF2"],
      [24565, "Unknown_5FF5"],
      [24566, "PidTagRecipientDisplayName"],
      [24567, "PidTagRecipientEntryId"],
      [24571, "PidTagRecipientTrackStatusTime"],
      [24573, "PidTagRecipientFlags"],
      [24575, "PidTagRecipientTrackStatus"],
      [24577, "PidTagNickname"],
      [26128, "Unknown_6610"],
      [26132, "Unknown_6614"],
      [26135, "Unknown_6617"],
      [26137, "PidTagUserEntryId"],
      [26435, "Unknown_6743"],
      [26436, "Unknown_6744"],
      [26610, "PidTagLtpRowId"],
      [26611, "PidTagLtpRowVer"],
      [26612, "Unknown_67F4"],
      [32762, "PidTagAttachmentLinkId"],
      [32763, "PidTagExceptionStartTime"],
      [32764, "PidTagExceptionEndTime"],
      [32765, "PidTagAttachmentFlags"],
      [32766, "PidTagAttachmentHidden"],
      [32767, "PidTagAttachmentContactPhoto"],
      [16378, "PidTagLastModifiedName_W"],
      [16379, "PidTagLastModifierEntryId"]
    ]);
    PSTUtil.NID_TYPE_HID = 0;
    PSTUtil.NID_TYPE_INTERNAL = 1;
    PSTUtil.NID_TYPE_NORMAL_FOLDER = 2;
    PSTUtil.NID_TYPE_SEARCH_FOLDER = 3;
    PSTUtil.NID_TYPE_NORMAL_MESSAGE = 4;
    PSTUtil.NID_TYPE_ATTACHMENT = 5;
    PSTUtil.NID_TYPE_SEARCH_UPDATE_QUEUE = 6;
    PSTUtil.NID_TYPE_SEARCH_CRITERIA_OBJECT = 7;
    PSTUtil.NID_TYPE_ASSOC_MESSAGE = 8;
    PSTUtil.NID_TYPE_CONTENTS_TABLE_INDEX = 10;
    PSTUtil.NID_TYPE_RECEIVE_FOLDER_TABLE = 11;
    PSTUtil.NID_TYPE_OUTGOING_QUEUE_TABLE = 12;
    PSTUtil.NID_TYPE_HIERARCHY_TABLE = 13;
    PSTUtil.NID_TYPE_CONTENTS_TABLE = 14;
    PSTUtil.NID_TYPE_ASSOC_CONTENTS_TABLE = 15;
    PSTUtil.NID_TYPE_SEARCH_CONTENTS_TABLE = 16;
    PSTUtil.NID_TYPE_ATTACHMENT_TABLE = 17;
    PSTUtil.NID_TYPE_RECIPIENT_TABLE = 18;
    PSTUtil.NID_TYPE_SEARCH_TABLE_INDEX = 19;
    PSTUtil.NID_TYPE_LTP = 31;
...
// node_modules/pst-extractor/dist/DescriptorIndexNode.class.js
var require_DescriptorIndexNode_class = __commonJS({
  "node_modules/pst-extractor/dist/DescriptorIndexNode.class.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.DescriptorIndexNode = void 0;
    var PSTFile_class_1 = require_PSTFile_class();
    var PSTUtil_class_1 = require_PSTUtil_class();
    var DescriptorIndexNode = class {
      get descriptorIdentifier() {
        return this._descriptorIdentifier;
      }
...
// node_modules/pst-extractor/dist/PSTMessageStore.class.js
var require_PSTMessageStore_class = __commonJS({
  "node_modules/pst-extractor/dist/PSTMessageStore.class.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.PSTMessageStore = void 0;
    var PSTObject_class_1 = require_PSTObject_class();
    var PSTMessageStore = class extends PSTObject_class_1.PSTObject {
      /**
...
// node_modules/pst-extractor/dist/NodeMap.class.js
var require_NodeMap_class = __commonJS({
  "node_modules/pst-extractor/dist/NodeMap.class.js"(exports) {
    "use strict";
    var __importDefault = exports && exports.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
    ...
    var NodeMap = class {
      constructor() {
        ...
        this.idToNumericName = /* @__PURE__ */ new Map();
        this.idToStringName = /* @__PURE__ */ new Map();
      }
      /**
      ...
      setId(key, propId, idx) {
        if (typeof key === "number" && idx !== void 0) {
...
var require_PSTFile_class = __commonJS({
  "node_modules/pst-extractor/dist/PSTFile.class.js"(exports) {
    "use strict";
    var __createBinding = exports && exports.__createBinding || (Object.create ? (function(o, m, k, k2) {
      if (k2 === void 0) k2 = k;
      var desc = Object.getOwnPropertyDescriptor(m, k);
    ...
    var long_1 = __importDefault(require_umd());
    var DescriptorIndexNode_class_1 = require_DescriptorIndexNode_class();
    var OffsetIndexItem_class_1 = require_OffsetIndexItem_class();
    var PSTDescriptorItem_class_1 = require_PSTDescriptorItem_class();
    var PSTFolder_class_1 = require_PSTFolder_class();
    var PSTMessageStore_class_1 = require_PSTMessageStore_class();
    var PSTNodeInputStream_class_1 = require_PSTNodeInputStream_class();
    var PSTTableBC_class_1 = require_PSTTableBC_class();
    var PSTUtil_class_1 = require_PSTUtil_class();
    var NodeMap_class_1 = require_NodeMap_class();
    var uuidparse = require_uuid_parse();
    var PSTFile2 = class _PSTFile {
      get encryptionType() {
      ...
      constructor(arg) {
        ...
        if (buffer[10] === _PSTFile.PST_TYPE_ANSI_2) {
          buffer[10] = _PSTFile.PST_TYPE_ANSI;
        }
        if (buffer[10] !== _PSTFile.PST_TYPE_ANSI && buffer[10] !== _PSTFile.PST_TYPE_UNICODE && buffer[10] !== _PSTFile.PST_TYPE_2013_UNICODE) {
          throw new Error("PSTFile::open Unrecognised PST File version: " + buffer[10]);
        }
        this._pstFileType = buffer[10];
        if (this._pstFileType === _PSTFile.PST_TYPE_ANSI) {
          this._encryptionType = buffer[461];
        } else {
          this._encryptionType = buffer[513];
        }
        if (this._encryptionType === 2) {
      ...
      processNameToIDMap() {
        ...
        for (let x = 0; x + 8 < nameToIdByte.length; x += 8) {
          ...
          if ((guid & 1) == 0) {
            ...
            let guidIndex;
            if (guid == 1) {
              guidIndex = _PSTFile.PS_MAPI;
            } else if (guid == 2) {
              guidIndex = _PSTFile.PS_PUBLIC_STRINGS;
            } else {
              guidIndex = guidIndexes[guid - 3];
            }
            _PSTFile.nodeMap.setId(key, propId, guidIndex);
          } else {
            ...
            if (len > 0 && len <= stringNameToIdByte.length) {
              ...
              propId += 32768;
              _PSTFile.nodeMap.setId(keyByteValue.toString("utf16le").replace(/\0/g, ""), propId);
            }
          }
        }
      }
      ...
      getNameToIdMapItem(key, idx) {
        return _PSTFile.nodeMap.getId(key, idx);
      }
      /**
      ...
      static getPublicStringToIdMapItem(key) {
        return _PSTFile.nodeMap.getId(key);
      }
      /**
      ...
      static getNameToIdMapKey(propId) {
        return _PSTFile.nodeMap.getNumericName(propId);
      }
      /**
       ...
       */
      getMessageStore() {
        const messageStoreDescriptor = this.getDescriptorIndexNode(long_1.default.fromNumber(_PSTFile.MESSAGE_STORE_DESCRIPTOR_IDENTIFIER));
       ...
       */
      getRootFolder() {
        const rootFolderDescriptor = this.getDescriptorIndexNode(long_1.default.fromValue(_PSTFile.ROOT_FOLDER_DESCRIPTOR_IDENTIFIER));
      ...
      getLeafSize(bid) {
        const offsetItem = this.getOffsetIndexNode(bid);
        if ((offsetItem.indexIdentifier.toNumber() & 2) == 0) {
      ...
      extractLEFileOffset(startOffset) {
        ...
        if (this._pstFileType == _PSTFile.PST_TYPE_ANSI) {
          ...
          this.readCompletely(buffer);
          offset = offset.or(buffer[3] & 255);
          offset = offset.shiftLeft(8);
          offset = offset.or(buffer[2] & 255);
          offset = offset.shiftLeft(8);
          offset = offset.or(buffer[1] & 255);
          offset = offset.shiftLeft(8);
          offset = offset.or(buffer[0] & 255);
        } else {
          this.seek(startOffset);
          const buffer = Buffer.alloc(8);
          this.readCompletely(buffer);
          offset = offset.or(buffer[7] & 255);
          let tmpLongValue;
          for (let x = 6; x >= 0; x--) {
            offset = offset.shiftLeft(8);
            tmpLongValue = buffer[x] & 255;
      ...
      findBtreeItem(index, descTree) {
        ...
        } else if (this._pstFileType === _PSTFile.PST_TYPE_2013_UNICODE) {
        ...
        while (buffer[0] === b2[0] && buffer[1] === b2[0] && !descTree || buffer[0] === b2[1] && buffer[1] === b2[1] && descTree) {
          ...
          let numberOfItems = 0;
          if (this._pstFileType === _PSTFile.PST_TYPE_2013_UNICODE) {
      ...
      getPSTDescriptorItems(arg) {
        ...
        if (blockType !== _PSTFile.SLBLOCK_ENTRY && blockType !== _PSTFile.SIBLOCK_ENTRY) {
        ...
        for (let x = 0; x < numberOfItems.toNumber(); x++) {
          ...
          if (blockType == _PSTFile.SLBLOCK_ENTRY) {
      ...
      getChildDescriptorTree() {
        if (!this.childrenDescriptorTree) {
          ...
          this.childrenDescriptorTree = /* @__PURE__ */ new Map();
    ...
    exports.PSTFile = PSTFile2;
    PSTFile2.ENCRYPTION_TYPE_NONE = 0;
    PSTFile2.ENCRYPTION_TYPE_COMPRESSIBLE = 1;
    PSTFile2.MESSAGE_STORE_DESCRIPTOR_IDENTIFIER = 33;
    PSTFile2.ROOT_FOLDER_DESCRIPTOR_IDENTIFIER = 290;
    PSTFile2.PST_TYPE_ANSI = 14;
    PSTFile2.PST_TYPE_ANSI_2 = 15;
    PSTFile2.PST_TYPE_UNICODE = 23;
    PSTFile2.PST_TYPE_2013_UNICODE = 36;
    PSTFile2.PS_PUBLIC_STRINGS = 0;
    PSTFile2.PS_INTERNET_HEADERS = 3;
    PSTFile2.PSETID_Messaging = 7;
    PSTFile2.PSETID_Note = 8;
    PSTFile2.PSETID_PostRss = 9;
    PSTFile2.PSETID_Task = 10;
    PSTFile2.PSETID_UnifiedMessaging = 11;
    PSTFile2.PS_MAPI = 12;
    PSTFile2.PSETID_AirSync = 13;
    PSTFile2.PSETID_Sharing = 14;
    PSTFile2.SLBLOCK_ENTRY = 0;
    PSTFile2.SIBLOCK_ENTRY = 1;
    PSTFile2.nodeMap = new NodeMap_class_1.NodeMap();
  }
});

// node_modules/pst-extractor/dist/index.js
var require_dist = __commonJS({
  "node_modules/pst-extractor/dist/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.PSTFolder = exports.PSTMessage = exports.PSTAttachment = exports.PSTRecipient = exports.PSTTask = exports.PSTFile = void 0;
    var PSTFile_class_1 = require_PSTFile_class();
    Object.defineProperty(exports, "PSTFile", { enumerable: true, get: function() {
      return PSTFile_class_1.PSTFile;
    } });
    var PSTTask_class_1 = require_PSTTask_class();
    Object.defineProperty(exports, "PSTTask", { enumerable: true, get: function() {
      return PSTTask_class_1.PSTTask;
    } });
    var PSTRecipient_class_1 = require_PSTRecipient_class();
    Object.defineProperty(exports, "PSTRecipient", { enumerable: true, get: function() {
      return PSTRecipient_class_1.PSTRecipient;
    } });
    var PSTAttachment_class_1 = require_PSTAttachment_class();
    Object.defineProperty(exports, "PSTAttachment", { enumerable: true, get: function() {
      return PSTAttachment_class_1.PSTAttachment;
    } });
    var PSTMessage_class_1 = require_PSTMessage_class();
    Object.defineProperty(exports, "PSTMessage", { enumerable: true, get: function() {
      return PSTMessage_class_1.PSTMessage;
    } });
    var PSTFolder_class_1 = require_PSTFolder_class();
    Object.defineProperty(exports, "PSTFolder", { enumerable: true, get: function() {
      return PSTFolder_class_1.PSTFolder;
    } });
  }
});

// src/lib/pstParser.ts
var import_pst_extractor = __toESM(require_dist(), 1);
...
function decodePstCompressibleBuffer(data) {
  const result = Buffer2.alloc(data.length);
  for (let i = 0; i < data.length; i++) {
    result[i] = PST_COMP_ENC[data[i]];
  }
  return result;
}
function normalizeFolderName(folderName, path) {
...
async function parsePstOrMailboxBinary(arrayBuffer, fileName, lastModified) {
  const buf = Buffer2.from(arrayBuffer);
  const results = [];
  const seenFingerprints = /* @__PURE__ */ new Set();
  const isPstMagic = buf.length >= 4 && buf[0] === 33 && buf[1] === 66 && buf[2] === 68 && buf[3] === 78;
  const isOleMsg = buf.length >= 8 && buf[0] === 208 && buf[1] === 207 && buf[2] === 17 && buf[3] === 224 && buf[4] === 161 && buf[5] === 177 && buf[6] === 26 && buf[7] === 225;
  const isPstExtension = /\.(pst|ost)$/i.test(fileName);
  if (isPstMagic || isPstExtension) {
    try {
      const pstFile = new import_pst_extractor.PSTFile(buf);
    ...
    if (results.length === 0) {
      ...
      if (bCryptMethod === 1 && buf.length > 512) {
        ...
        processBuffer = Buffer2.concat([headerPart, decodedData]);
      }
...
function extractEmailsFromPstFolder(folder, currentPath, fileName, lastModified, results, seenFingerprints, maxEmails = 500) {
  const queue = [{ folder, path: currentPath }];
      ...
      try {
        ...
        while ((msg = curFolder.getNextChild()) !== null && results.length < maxEmails) {
          try {
            ...
            if (msg.displayTo) {
              toRecipients.push(
                ...msg.displayTo.split(/[,;]/).map((s) => s.trim()).filter(Boolean)
              );
            }
            ...
            const ccList = msg.displayCC ? msg.displayCC.split(/[,;]/).map((s) => s.trim()).filter(Boolean) : void 0;
            const bccList = msg.displayBCC ? msg.displayBCC.split(/[,;]/).map((s) => s.trim()).filter(Boolean) : void 0;
            let bodyText = msg.body || "";
            const bodyHtml = msg.bodyHTML || "";
            if (!bodyText && bodyHtml) {
              bodyText = bodyHtml.replace(/<style[^>]*>[\s\S]*?<\/style>/gi, "").replace(/<script[^>]*>[\s\S]*?<\/script>/gi, "").replace(/<[^>]+>/g, " ").replace(/\s+/g, " ").trim();
            }
              ...
              try {
                ...
                if (att) {
                  ...
                  attachments.push({
                    ...
                    suspiciousReason: isSuspAtt ? `Potentially executable or script attachment extension (.${attExt})` : void 0
                  });
                }
              } catch {
              }
            ...
            const hasUrgentFinancialKeyword = /wire transfer|urgent payment|account suspended|verify credentials|invoice attached|cryptocurrency|gift card|security alert|password reset|immediate action/i.test(
              lowerText
            );
            const isPhishing = hasSuspAttachment || hasUrgentFinancialKeyword;
            let phishingReason;
            if (hasSuspAttachment && hasUrgentFinancialKeyword) {
              phishingReason = "High-Risk Phishing: Contains urgent financial coercion and dangerous attachment payload";
            ...
            results.push({
              ...
              details: {
                ...
                "Date": emailDate,
                "Folder": folderType,
                "Attachments": attachments.length > 0 ? attachments.map((a) => `${a.name} (${a.size} bytes)`).join(", ") : "None",
...
function carveActualEmailsFromBuffer(buf, fileName, lastModified, pstVersion, cryptMethod) {
  const items = [];
  ...
  while ((headerMatch = headerMarkerRegex.exec(textAscii)) !== null && items.length < maxEmails) {
    ...
    const blockEnd = Math.min(startIndex + 16e3, textAscii.length);
...
function carveUtf16MapiEmails(buf, fileName, lastModified, startIndex) {
  const items = [];
  ...
  while ((sMatch = subjectRegex.exec(utf16String)) !== null && items.length < 20) {
    ...
    if (rawSubject.length < 3 || rawSubject.includes("\0")) continue;
    const windowStart = Math.max(0, sMatch.index - 1e3);
    const windowEnd = Math.min(utf16String.length, sMatch.index + 3e3);
    ...
    const bodyLines = windowText.split(/\r?\n/).map((l) => l.trim()).filter((l) => l.length > 8 && !l.includes("Subject:") && !l.includes("Date:"));
    const bodyText = bodyLines.slice(0, 10).join("\n\n") || `Extracted message communication regarding "${rawSubject}". Stream recovered from Unicode PST block.`;
    ...
    const emailData = {
      ...
      isPhishing,
      phishingReason: isPhishing ? "Social engineering indicator: High-urgency wording detected in message content" : void 0,
      read: true
    };
...
function carveEmailsFromMsgBuffer(buf, fileName, lastModified) {
  const text = buf.toString("latin1");
  const parsed = parseSingleEmailStream(text, fileName, "MSG Compound File", lastModified, 1);
  return parsed ? [parsed.artifact] : [];
}
function parseSingleEmailStream(rawBlock, fileName, location, lastModified, index) {
  ...
  const toMatch = /To:\s*([^\r\n]+)/i.exec(rawBlock);
  const toList = toMatch ? toMatch[1].split(/[,;]/).map((t) => t.trim()).filter(Boolean) : ["investigation-team@opencase.local"];
  const ccMatch = /Cc:\s*([^\r\n]+)/i.exec(rawBlock);
  const ccList = ccMatch ? ccMatch[1].split(/[,;]/).map((t) => t.trim()).filter(Boolean) : void 0;
  ...
  while ((attMatch = attachmentRegex.exec(rawBlock)) !== null) {
    ...
    attachments.push({
      name: attName,
      size: Math.floor(Math.random() * 45e4) + 12e3,
  ...
  if (hasSuspiciousAtt && hasPhishingKeywords) {
    phishingReason = "High-Risk Phishing: Urgent financial or coercive terminology combined with high-risk executable/script payload";
  ...
  return {
    ...
    artifact: {
      ...
      isSuspicious: isPhishing,
      suspiciousReason: phishingReason,
      rawText: rawBlock.slice(0, 2e3),
      emailData: extractedEmail
    }
  };
}
function parseEmailTextOrMime(textContent, fileName, lastModified) {
  const results = [];
  const maxMails = 60;
  const seenFingerprints = /* @__PURE__ */ new Set();
...
export {
  PST_COMP_ENC,
  decodePstCompressibleBuffer,
  parseEmailTextOrMime,
  parsePstOrMailboxBinary
};
/**
 * @license
